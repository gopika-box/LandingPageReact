  ...
  return (
    ...
    <nav className="absolute top-0 left-0 right-0 flex justify-between px-30 text-white h-15 p-2">
        ...
        <ul className="hidden sm:flex text-lg font-sans gap-4 mt-2 ">
          <li className="transtition delay-100 duration-300 ease-in hover:scale-102 hover:text-amber-300">Furniture</li>
          <li className="transtition delay-100 duration-300 ease-in hover:scale-102 hover:text-amber-300">Shop</li>
    ...
    <div className="flex flex-col h-screen items-center justify-center text-white">
      ...
      <p className="py-4 text-2xl font-extralight text-center">Turn your room with panto into a lot minimalist <br />
